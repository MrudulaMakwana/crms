...
const mockData = [
  { id: '#PUR0020', supplier: 'Alpha Supplies Inc', date: '11 Sep 2025', items: 12, amount: '$22,500', payment: 'Paid', status: 'Received' },
  { id: '#PUR0019', supplier: 'Beta Logistics Ltd', date: '05 Sep 2025', items: 8, amount: '$15,750', payment: 'Pending', status: 'Ordered' },
  { id: '#PUR0018', supplier: 'Star Printers Co', date: '27 Aug 2025', items: 5, amount: '$8,600', payment: 'Paid', status: 'Received' },
  { id: '#PUR0017', supplier: 'Quick Rentals', date: '16 Aug 2025', items: 3, amount: '$4,200', payment: 'Partial', status: 'In Transit' },
  { id: '#PUR0016', supplier: 'Bright Cleaning', date: '25 Jul 2025', items: 15, amount: '$28,400', payment: 'Paid', status: 'Received' },
  { id: '#PUR0015', supplier: 'Green Cafe Supplies', date: '12 Jul 2025', items: 6, amount: '$6,400', payment: 'Paid', status: 'Received' },
  { id: '#PUR0014', supplier: 'Tech Soft Ltd', date: '23 Jun 2025', items: 10, amount: '$11,300', payment: 'Pending', status: 'Ordered' },
  { id: '#PUR0013', supplier: 'Metro Cabs', date: '07 Jun 2025', items: 4, amount: '$7,850', payment: 'Paid', status: 'Cancelled' },
  { id: '#PUR0012', supplier: 'Horizon Supplies', date: '28 May 2025', items: 9, amount: '$13,400', payment: 'Paid', status: 'Received' },
  { id: '#PUR0011', supplier: 'City Power', date: '18 May 2025', items: 7, amount: '$4,900', payment: 'Paid', status: 'Received' },
];
          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50">
                <th className="px-6 py-4 text-[13px] font-bold text-slate-700 dark:text-slate-300">Reference</th>
                <th className="px-6 py-4 text-[13px] font-bold text-slate-700 dark:text-slate-300">Supplier</th>
                <th className="px-6 py-4 text-[13px] font-bold text-slate-700 dark:text-slate-300">Purchase Date</th>
                ...
                <th className="px-6 py-4 text-[13px] font-bold text-slate-700 dark:text-slate-300">Payment</th>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50">
              {mockData.map((row, idx) => (
                <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-sm text-slate-500 dark:text-slate-400">{row.payment}</td>
