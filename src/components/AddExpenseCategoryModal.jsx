...
import { X, Tag, AlignLeft, Activity } from 'lucide-react';
import api from '../services/api';

const AddExpenseCategoryModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('/finance/expense-categories/', formData);
      ...
      <div className="relative bg-white dark:bg-[#111624] w-full max-w-md rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-800 shrink-0 bg-slate-50 dark:bg-slate-900/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900 dark:text-white tracking-tight">Add Expense Category</h2>
              <p className="text-sm text-slate-500 dark:text-slate-400">Create a new category for expenses</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
          ...
          <form id="add-expense-category-form" onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <textarea 
                  ...
                  placeholder="Fuel and transport expenses..." 
                />
              </div>
            </div>
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-200 dark:border-slate-800 shrink-0 bg-slate-50/80 dark:bg-[#0b0f19]/80 backdrop-blur-md">
          ...
          <button 
            type="submit" 
            form="add-expense-category-form"
            disabled={isLoading}
